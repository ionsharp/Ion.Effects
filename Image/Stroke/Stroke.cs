...
[Group(nameof(ImageEffectGroup.Stroke))]
public class StrokeEffect : ImageEffect
{
    ...
    private static void OnSizeChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e) => (sender as StrokeEffect).TextureSize = new((sender as StrokeEffect).SizeX, (sender as StrokeEffect).SizeY);
