...
public class ChannelsEffect : BaseEffect
{
    ...
    private static void OnRedChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
    ...
    private static void OnGreenChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
    ...
    private static void OnBlueChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
