...
[Group(nameof(ImageEffectGroup.Distort))]
public class PixelateEffect : ImageEffect
{
    ...
    private static void OnSizeChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e) => (sender as PixelateEffect).Size = new((sender as PixelateEffect).PixelWidth, (sender as PixelateEffect).PixelHeight);
