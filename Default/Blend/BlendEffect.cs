...
public class BlendEffect : BaseEffect
{
    ...
    private static void OnActualBlendModeChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
    ...
    private static void OnActualMaskChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
    ...
    public BlendEffect() : base()
    {
        ...
        //SetCurrentValue(CInputProperty, new ImageBrush() { ImageSource = XWriteableBitmap.New(1, 1, Colors.White) });
