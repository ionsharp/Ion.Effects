...
[Group(nameof(ImageEffectGroup.Noise))]
public class NoiseEffect : ImageEffect
{
    ...
    private static void OnModeChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e) => (sender as NoiseEffect).ModeIndex = (int)(Modes)e.NewValue;
